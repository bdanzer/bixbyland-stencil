...
export class PropertyFilters {
    ...
    render() {
        return (h("div", { class: "property-filters" },
            ...
            h("input", { onChange: (e) => this.handleSearch(e), type: "text", value: (this.filters && this.filters.search) ? this.filters.search : '', placeholder: "Search properties by address or location", class: "search" }),
            h("select", { name: "cars", class: "dropdown", onChange: (e) => this.handleRegion(e) },
                h("option", { selected: true, disabled: true }, "Regions"),
