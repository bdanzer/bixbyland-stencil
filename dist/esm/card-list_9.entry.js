...
const NoUiSliderWrapper = class {
    ...
    render() {
        return (h(Host, null, h("slot", { name: "title" }), h("div", { class: "bixby-slider-row" }, h("span", { class: "handle-number" }, formatLargeNumber(this.min)), h("div", { ref: el => this.el = el, id: "double-slider" }), h("span", { class: "handle-number" }, formatLargeNumber(this.max)))));
    }
    static get watchers() { return {
        "start": ["watchStart"]
    }; }
