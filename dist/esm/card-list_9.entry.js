...
const NoUiSliderWrapper = class {
    ...
    render() {
        return (h(Host, null, h("slot", { name: "title" }), h("div", { class: "row" }, h("span", { class: "handle-number" }, "1"), h("div", { ref: el => this.el = el, id: "double-slider" }), h("span", { class: "handle-number" }, "600k"))));
    }
    static get watchers() { return {
        "start": ["watchStart"]
    }; }
