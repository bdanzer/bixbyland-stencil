...
const PropertyFilters = class {
    ...
    render() {
        return (h("div", { class: "property-filters" }, h("span", { class: "property-count-wrap" }, h("div", { class: "result-header" }, "Property Results"), h("span", { class: "property-count" }, "25"), " properties match your results"), h("input", { onChange: (e) => this.handleSearch(e), type: "text", value: (this.filters && this.filters.search) ? this.filters.search : '', placeholder: "Search properties by address or location", class: "search" }), h("select", { name: "cars", class: "dropdown", onChange: (e) => this.handleRegion(e) }, h("option", { selected: true, disabled: true }, "Regions"), h("option", { value: "saab" }, "Saab 95"), h("option", { value: "mercedes" }, "Mercedes SLK"), h("option", { value: "audi" }, "Audi TT")), h("no-ui-slider-wrapper", { start: (this.filters && this.filters.sqFootage) ? this.filters.sqFootage : [0, 100], callback: this.handleSqFeet.bind(this) }, h("slot", { name: "title" }, "Square Footage")), h("select", { name: "cars", class: "dropdown", onChange: (e) => this.handleSortBy(e) }, h("option", { selected: true, disabled: true }, "SortBy"), h("option", { value: "volvo" }, "Volvo XC90"), h("option", { value: "saab" }, "Saab 95"), h("option", { value: "mercedes" }, "Mercedes SLK"), h("option", { value: "audi" }, "Audi TT")), h("button", { onClick: () => { this.handleResetFilters(); }, class: "reset-button" }, "Reset Filters")));
    }
