...
const loadPosts = () => async (dispatch, _getState) => {
    ...
    try {
        let response = await axios$1.get(baseUrl + fetchUrl, {
...
const PortfolioApp = class {
    ...
    render() {
        return (core.h(core.Host, { class: "portfolio-app" }, core.h("filter-header-bar", { activeFilter: this.filters.category, filter: this.handleFilter.bind(this), view: this.handleView.bind(this) }), core.h("property-info-bar", null), core.h("property-filters", null), core.h("property-listings", { class: this.views, view: this.views, posts: this.posts })));
    }
    static get watchers() { return {
