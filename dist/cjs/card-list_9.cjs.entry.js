...
const PropertyFilters = class {
    ...
    async getRegions() {
        let response = await axios$1.get('https://bixbyland.coreylowe.io/wp-json/bixby/v1/properties/regions');
