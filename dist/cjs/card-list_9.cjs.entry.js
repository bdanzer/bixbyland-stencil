...
const core = require('./core-46b511e6.js');
...
function scrollTo(parent, target, options = {}) {
    let defaults = Object.assign({ offset: 0 }, options);
...
const CardList = class {
    ...
    render() {
        return (this.posts && core.h(core.Host, null, this.posts.map(post => {
            return (core.h("property-card", { ref: (el) => this.handleRef(el, post), view: this.views, onClick: () => this.handleCard(post), activePostId: this.activePostId, postData: post }));
        })));
    }
...
const GoogleMap = class {
    ...
    async getIcons() {
        if (!this.icons) {
            let res = await axios$1.get(this.baseUrl + '/wp-json/bixby/v1/theme-settings');
...
const PropertyInfoBar = class {
    ...
    render() {
        return (core.h("div", { class: "property-info-bar" }, core.h("div", { class: "property-info-bar-wrap" }, core.h("span", { class: "property-count-wrap" }, core.h("div", { class: "property-info-header" }, this.category, " Properties"), core.h("span", { class: "property-info-subheader" }, "Completed or Underway")), this.countPosts() != 0 ?
            core.h("div", { class: "property-info-stats" }, core.h("span", { class: "number-wrap" }, this.countPosts()), "Properties") : '', this.getSQFT() != 0 ?
            core.h("div", { class: "property-info-stats" }, core.h("span", { class: "number-wrap" }, this.getSQFT()), "Square Feet") : '', this.getPrice() != 0 ?
            core.h("div", { class: "property-info-stats" }, core.h("span", { class: "number-wrap" }, this.getPrice()), "Value") : '')));
    }
    static get watchers() { return {
        "filters": ["watchPosts"]
    }; }
