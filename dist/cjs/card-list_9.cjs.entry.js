...
const NoUiSliderWrapper = class {
    ...
    render() {
        return (core.h(core.Host, null, core.h("slot", { name: "title" }), core.h("div", { class: "row" }, core.h("span", { class: "handle-number" }, "1"), core.h("div", { ref: el => this.el = el, id: "double-slider" }), core.h("span", { class: "handle-number" }, "600k"))));
    }
    static get watchers() { return {
        "start": ["watchStart"]
    }; }
