...
const PortfolioApp = class {
    ...
    componentWillLoad() {
        ...
        Endpoint$1.baseUrl = this.baseUrl;
        this.checkUrl();
    }
...
const PropertyFilters = class {
    ...
    async getRegions() {
        let response = await axios$1.get(Endpoint$1.baseUrl + '/wp-json/bixby/v1/properties/regions');
    ...
    async getMinMaxSqFt(category = 'all') {
        let response = await axios$1.get(Endpoint$1.baseUrl + '/wp-json/bixby/v1/properties/category-info', {
            params: {
                category: category
            }
        });
        let newData = map((data) => data.sq_ft, response.data);
        let sortedArray = sortBy((data) => parseInt(data), newData);
