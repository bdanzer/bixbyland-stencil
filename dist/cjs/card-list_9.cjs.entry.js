...
const CardList = class {
    ...
    render() {
        return (this.posts && core.h(core.Host, null, this.posts.map(post => {
            return (core.h("property-card", { view: this.views, onClick: () => this.handleCard(post), activePostId: this.activePostId, postData: post }));
        })));
    }
...
const GoogleMap = class {
    ...
    async getIcons() {
        if (!this.icons) {
            let res = await axios$1.get('https://bixbyland.coreylowe.io/wp-json/bixby/v1/theme-settings');
            let icons = map((themeOptions) => {
...
const PropertyCard = class {
    ...
    render() {
        const Card = (core.h("div", { class: `property-card${(this.postData.ID == this.activePostId) ? ' active' : ''}` }, core.h("div", { class: "property-card-content-wrap" }, core.h("div", { class: "property-image-wrap" }, core.h("img", { src: this.postData.thumbnail })), core.h("div", { class: "property-content" }, core.h("div", { class: "property-content-wrap" }, core.h("span", { class: "property-title" }, core.h("div", { class: "property-address" }, this.getPostTitle(), ","), " ", this.postData.meta.city[0], " ", this.postData.meta.state_code[0], " ", this.postData.meta.zip_code[0]), core.h("p", null, core.h("span", null, "Region:"), " ", this.postData.meta.region[0]), core.h("p", null, core.h("span", null, "Submarket:"), " ", this.postData.meta.sub_market[0]), core.h("p", null, core.h("span", null, "Total SQ FT:"), " ", this.postData.meta.sq_ft[0]), core.h("a", { class: "post-link", href: this.postData.link }, "View Details"))))));
        if (this.view == 'grid') {
            return (core.h("a", { href: this.postData.link }, Card));
        }
        return Card;
    }
