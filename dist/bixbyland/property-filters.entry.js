...
import { c as createCommonjsModule } from './_commonjsHelpers-b12caf5b.js';
...
const PropertyFilters = class {
    ...
    render() {
        return [
            h("div", { class: "property-filters" }, h("span", { class: "property-count-wrap" }, h("div", { class: "result-header" }, "Property Results"), h("span", { class: "property-count" }, "25"), " properties match your results"), h("input", { type: "text", value: "", placeholder: "Search properties by address or location", class: "search" }), h("select", { name: "cars", class: "dropdown" }, h("option", { value: "volvo" }, "Volvo XC90"), h("option", { value: "saab" }, "Saab 95"), h("option", { value: "mercedes" }, "Mercedes SLK"), h("option", { value: "audi" }, "Audi TT"), h("img", { class: "navbar-dropdown-carat", src: "http://bixbyland.test/app/themes/bixbyland/dist/images/dropdown_caret_3d30fbac.svg" })), h("select", { name: "cars", class: "dropdown" }, h("option", { value: "volvo" }, "Volvo XC90"), h("option", { value: "saab" }, "Saab 95"), h("option", { value: "mercedes" }, "Mercedes SLK"), h("option", { value: "audi" }, "Audi TT")), h("button", { class: "reset-button" }, "Reset Filters")),
