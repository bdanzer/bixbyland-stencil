...
var _this = this;
import { r as registerInstance, g as getContext, h, H as Host } from './core-790bee4a.js';
var Actions;
(function (Actions) {
...
var loadPosts = function () { return function (dispatch, _getState) { return __awaiter(_this, void 0, void 0, function () {
    var _d, filters, fetchUrl, response, e_1;
    return __generator(this, function (_f) {
        switch (_f.label) {
            case 0:
                _d = _getState().dataReducer, filters = _d.filters, fetchUrl = _d.fetchUrl;
                _f.label = 1;
            case 1:
                _f.trys.push([1, 3, , 4]);
                return [4 /*yield*/, axios$1.get(fetchUrl, {
...
var FilterHeaderBar = /** @class */ (function () {
    ...
    class_2.prototype.getViews = function () {
        ...
        var _loop_1 = function (viewType) {
            ...
            views.push(h("div", { class: (this_1.activeView == viewType) ? 'active' : '', onClick: function () { return _this.handleView(viewType); } }, viewName));
        };
        var this_1 = this;
    ...
    class_2.prototype.render = function () {
        var _this = this;
        return (h(Host, null, h("div", { class: "filter-wrap" }, h("div", { class: "filters" }, h("span", null, "Filter by:"), h("div", { class: (this.activeFilter == 'all') ? 'active' : '', onClick: function () { return _this.handleFilter('all'); } }, "All"), this.categories.map(function (category) {
...
var NoUiSliderWrapper = /** @class */ (function () {
    ...
    class_4.prototype.render = function () {
        ...
        return [
            h("slot", { name: "title" }),
            h("div", { ref: function (el) { return _this.el = el; }, id: "double-slider" })
        ];
    };
...
var PortfolioApp = /** @class */ (function () {
    ...
    class_5.prototype.componentWillLoad = function () {
        ...
        this.store.mapStateToProps(this, function (state) {
            var _d = state.dataReducer, posts = _d.posts, filter = _d.filter, views = _d.views;
            return {
                posts: posts,
                filter: filter,
                views: views
...
var PropertyFilters = /** @class */ (function () {
    ...
    class_7.prototype.componentDidLoad = function () {
        this.store.mapStateToProps(this, function (state) {
            var filters = state.dataReducer.filters;
            return {
                filters: filters
            };
        });
    ...
    class_7.prototype.handleSortBy = function (_e) {
    };
    ...
    class_7.prototype.render = function () {
        var _this = this;
        return (h("div", { class: "property-filters" }, h("span", { class: "property-count-wrap" }, h("div", { class: "result-header" }, "Property Results"), h("span", { class: "property-count" }, "25"), " properties match your results"), h("input", { onChange: function (e) { return _this.handleSearch(e); }, type: "text", value: (this.filters && this.filters.search) ? this.filters.search : '', placeholder: "Search properties by address or location", class: "search" }), h("select", { name: "cars", class: "dropdown", onChange: function (e) { return _this.handleRegion(e); } }, h("option", { selected: true, disabled: true }, "Regions"), h("option", { value: "saab" }, "Saab 95"), h("option", { value: "mercedes" }, "Mercedes SLK"), h("option", { value: "audi" }, "Audi TT")), h("no-ui-slider-wrapper", { start: (this.filters && this.filters.sqFootage) ? this.filters.sqFootage : [0, 100], callback: this.handleSqFeet.bind(this) }, h("slot", { name: "title" }, "Square Footage")), h("select", { name: "cars", class: "dropdown", onChange: function (e) { return _this.handleSortBy(e); } }, h("option", { selected: true, disabled: true }, "SortBy"), h("option", { value: "volvo" }, "Volvo XC90"), h("option", { value: "saab" }, "Saab 95"), h("option", { value: "mercedes" }, "Mercedes SLK"), h("option", { value: "audi" }, "Audi TT")), h("button", { onClick: function () { _this.handleResetFilters(); }, class: "reset-button" }, "Reset Filters")));
    };
...
var PropertyInfoBar = /** @class */ (function () {
    ...
    class_8.prototype.componentDidLoad = function () {
        this.store.mapStateToProps(this, function (state) {
            var posts = state.dataReducer.posts;
            return {
                posts: posts
            };
        });
    ...
    class_8.prototype.createInfoObj = function () {
        // R.objOf('propertyInfo')
        // var sqFt = 0;
        var func = function (obj) { return (obj.meta.sq_ft[0]) ? parseInt(obj.meta.sq_ft[0]) : 0; };
        console.log(map(func, this.posts));
        var number = sum(map(func, this.posts));
    ...
    class_8.prototype.getSubString = function (numberString, removeNumber) {
        return numberString.substring(0, numberString.length - removeNumber);
    };
    class_8.prototype.getPrice = function () {
        // R.objOf('propertyInfo')
        // var sqFt = 0;
        var func = function (obj) { return (obj.meta.price[0]) ? parseInt(obj.meta.price[0]) : 0; };
        console.log(map(func, this.posts));
        var number = sum(map(func, this.posts));
        var numberString = number.toString();
        var numberLength = number.toString().length;
