            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios$1.get('https://bixbyland.coreylowe.io/wp-json/bixby/v1/theme-settings')];
                    case 1:
                        res = _d.sent();
...
var PropertyInfoBar = /** @class */ (function () {
    ...
    class_8.prototype.componentDidLoad = function () {
        this.store.mapStateToProps(this, function (state) {
            var _d = state.dataReducer, filters = _d.filters, baseUrl = _d.baseUrl;
            return {
                filters: filters, baseUrl: baseUrl
            };
        });
    };
