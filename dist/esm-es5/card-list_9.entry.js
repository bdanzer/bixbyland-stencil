...
var GoogleMap = /** @class */ (function () {
    ...
    class_3.prototype.findLatitudeAvg = function () {
        ...
        var long = mean(map(function (post) { return post.meta.longitude[0]; }, this.posts));
        return {
            "lat": lat,
            "lng": long
        };
...
var PropertyFilters = /** @class */ (function () {
    ...
    class_7.prototype.componentDidLoad = function () {
        this.store.mapStateToProps(this, function (state) {
            var _d = state.dataReducer, filters = _d.filters, posts = _d.posts;
            return {
                filters: filters, posts: posts
            };
        });
        this.store.mapDispatchToProps(this, {
            changeFilter: changeFilter,
    ...
    class_7.prototype.getRegions = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, axios$1.get('https://bixbyland.coreylowe.io/wp-json/bixby/v1/properties/regions')];
                    case 1:
                        response = _d.sent();
    ...
    class_7.prototype.render = function () {
        var _this = this;
        return [
            h("div", { class: "property-filters" + ((this.modal) ? ' modal-state' : '') }, h("span", { class: "property-count-wrap" }, h("div", { class: "result-header" }, "Property Results"), h("span", { class: "property-count" }, this.posts.length), " properties match your results"), (this.modal) && (h("span", { class: "filter-title" }, "Filter")), h("input", { onChange: function (e) { return _this.handleSearch(e); }, type: "text", value: (this.filters && this.filters.search) ? this.filters.search : '', placeholder: "Search properties by address or location", class: "search" }), h("select", { name: "regions", class: "dropdown", onChange: function (e) { return _this.handleRegion(e); } }, h("option", { selected: true, disabled: true }, "Regions"), this.regions.map(function (region) { return h("option", { value: region.meta_value }, region.meta_value); })), h("no-ui-slider-wrapper", { start: (this.filters && this.filters.sqFootage) ? this.filters.sqFootage : [0, 100], callback: this.handleSqFeet.bind(this) }, h("slot", { name: "title" }, "Square Footage")), h("select", { name: "sortby", class: "dropdown", onChange: function (e) { return _this.handleSortBy(e); } }, h("option", { selected: true, disabled: true }, "SortBy")), h("button", { onClick: function () { (_this.modal) ? _this.modal = !_this.modal : _this.handleResetFilters(); }, class: "reset-button" }, (this.modal) ? 'Apply' : 'Reset Filters'), h("div", { class: "modal-close-button", onClick: function () { _this.modal = !_this.modal; } }, "X")),
